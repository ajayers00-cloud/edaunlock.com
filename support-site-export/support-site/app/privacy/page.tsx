    ...
    <main className="privacy-main" id="main-content">
      ...
      <div className="privacy-content shell">
        ...
        <article className="privacy-copy">
          ...
          <section><h2>Children</h2><p>EDA Unlock is intended for adults age 18 and older and is not directed to children or minors. K–12 labels describe educational material and starting levels; they do not make the app child-directed.</p></section>
