globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-Cz8lmKdi.js","assets/link-BIScx47-.js","assets/router-CO8bzDOx.js"];
...
var supportEmail$2 = "Eda.learning.hq@gmail.com";
var helpTopics = [
	{
		number: "01",
...
var faqs = [
	...
	},
	{
		...
		answer: "No. Your profile and password are created locally on your device. This version has no account service, advertising, third-party analytics, cloud sync, or backup restore. Resetting or replacing the device starts a new profile."
	},
	{
...
function PrivacyPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "privacy-hero shell",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "eyebrow",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), " Privacy"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
						"Your learning stays",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "EDA Unlock is designed as a local-first utility. This page explains what the current iOS version stores, when information can leave your device, and the controls available to you." })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "privacy-content shell",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
					className: "privacy-meta",
					children: [
						"Effective",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "August 4, 2026" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						"Version",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The app stores the information needed for your chosen experience: an optional display name, local password verifier and login-throttle record, enabled learning banks, challenge settings, learning progress, answer and unlock history, optional bypass history, and the versions and acceptance time of the Terms and Privacy Policy you acknowledged." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "These records are device-only and are excluded from backup and cross-device restore. EDA Unlock has no v1 account-recovery or migration service. A replacement, restored, or newly installed device therefore starts with a new profile." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
								...
								". Nothing is sent until you review the complete draft and choose Send in your email app."
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "A general feedback draft includes what you type plus the app version/build, build channel, iOS version, and generic device model. A question report also includes the question ID, bank, level, type, prompt, displayed choices, expected answer, source label, and review status. The app does not automatically attach your profile, password data, Screen Time selection, answer history, unlock history, or bypass history." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Your email provider handles delivery, and the recipient mailbox is operated through Google. Delivery may include your sender address and other information visible in the composer. Support messages are used only to respond, investigate content or rights reports, protect the service, and improve EDA Unlock." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Retention and deletion" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "On-device records remain until you reset them or remove the app under iOS behavior. Support and question-report email is kept only while the request is being handled and for no more than 90 days after it is closed, unless law, a security or fraud investigation, or an active dispute requires longer. A verified deletion request will be handled within 30 days where legally permitted; provider backups may expire on the provider’s normal schedule." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ul", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Change or remove protected selections inside EDA Unlock." }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Pause the guard and revoke Screen Time permission through iOS Settings." }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Reset learning progress while keeping the profile." }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Use Reset Profile to remove EDA Unlock’s local profile, settings, histories, Screen Time selection, extension state, and credential." }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [
									"Email ",
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
										href: `mailto:${supportEmail$1}?subject=EDA%20Unlock%20Deletion%20Request`,
										children: supportEmail$1
									}),
									" to request deletion of a support message."
								] })
							] })
						] }),
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "eyebrow",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), " Terms of Use"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
						"Know the limits",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "These Terms explain EDA Unlock's purpose, the limits of its Screen Time controls, and the important boundaries around its educational content." })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "privacy-content shell",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									...
									children: "Standard Licensed Application End User License Agreement"
								}),
								", which governs the App Store license. Apple is not a party to these supplemental Terms and is not responsible for EDA Unlock or its question content. The Standard EULA and any rights that cannot be waived under applicable law control if there is a conflict."
							] }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "What EDA Unlock does" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "EDA Unlock is a local-first self-control and study utility. It lets a device owner voluntarily use Apple Screen Time features to place friction before selected apps, categories, or websites. A learning challenge or the optional emergency bypass can create a temporary unlock." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "EDA Unlock is not parental surveillance, enterprise device management, addiction treatment, an emergency-safety system, or guaranteed access-control software." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Screen Time and emergency limits" }),
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The device owner can revoke authorization, change iOS settings, delete the app, or use Apple recovery controls. EDA Unlock provides helpful friction, not tamper-proof enforcement." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Do not rely on EDA Unlock where delayed access to your phone could create danger, including while driving, operating machinery, caring for another person, or responding to an emergency. Maintain another safe way to reach emergency communications. In an emergency, call your local emergency-services number." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Education and certification limits" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Questions, explanations, scores, streaks, levels, and progress indicators are for general learning and personal reflection. They are not proof of knowledge, competence, qualification, or professional readiness." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "EDA Unlock is not an accredited school, testing organization, certification provider, or continuing-education provider. It does not provide professional, licensing, certification, or continuing-education credit and does not guarantee exam passage, admission, employment, professional competence, or any other outcome." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Medical and emergency-care content" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Medical, nursing, pharmacy, fitness, nutrition, EMT, paramedic, first-aid, and emergency-care material is general educational information. It is not medical advice, diagnosis, treatment, prescribing guidance, patient-specific clinical decision support, or a substitute for current accredited training." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Do not use EDA Unlock to make decisions about a patient, medication, dosage, diagnosis, treatment, or emergency response. Do not delay or disregard professional care because of anything in the app. Consult an appropriately licensed healthcare professional before making medical decisions. In an emergency, contact local emergency services and follow current instructions from qualified responders." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Legal and tax content" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Legal and tax material is general educational information, not legal advice, tax advice, filing guidance, or an interpretation of your rights or obligations. Using EDA Unlock does not create an attorney-client, accountant-client, tax-preparer, or other professional relationship." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Laws, regulations, filing rules, deadlines, and interpretations vary by jurisdiction and change over time. Verify current official sources and consult a qualified professional familiar with your circumstances." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Financial and investment content" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Financial, accounting, investing, trading, risk, real-estate, and business material is educational only. It is not personalized financial, investment, securities, accounting, or fiduciary advice and is not an offer, recommendation, endorsement, or solicitation to buy or sell anything." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "EDA Unlock does not consider your goals, finances, tax position, risk tolerance, or circumstances. Investments can lose some or all of their value. Consult an appropriately qualified professional and review current official materials before making financial decisions." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Accuracy and changing information" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "EDA Unlock may make reasonable efforts to review and correct content, but it does not guarantee that every question, answer, explanation, date, source label, or jurisdiction is complete, current, or error-free. Professional standards, laws, medical guidance, tax rules, technologies, and market practices can change." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "A content status such as “reviewed” does not mean that a government agency, licensing body, examination owner, or other third party approved the material. Verify safety-sensitive and time-sensitive information using current authoritative sources." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "No affiliation or endorsement" }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
								"Report a content-rights concern to ",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: `mailto:${supportEmail}?subject=EDA%20Unlock%20Content%20Rights`,
									children: supportEmail
								}),
								" with enough information to identify the material and explain the concern."
							] })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Feedback, support, and privacy" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Feedback is optional. When you send feedback or flag a question, EDA Unlock prepares an email that you can review and edit before sending. Your email provider handles delivery under its own terms. Do not include passwords, confidential records, unnecessary medical or financial details, or information you do not have permission to share." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "By submitting feedback, you permit the App Store seller or developer to use it as reasonably needed to respond, investigate reported content, correct the library, and improve EDA Unlock. There is no obligation to implement or pay for a suggestion." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
								"The current app does not require an online account and does not include advertising, tracking, third-party analytics, EDA Unlock cloud sync, or backup restore. V1 profile and progress records are device-only. Read the ",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "/privacy",
									children: "Privacy notice"
								}),
								" for details about local storage, temporary shield-origin data, optional email, provider handling, retention, deletion controls, and Apple services."
							] })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "TestFlight, availability, and changes" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "A TestFlight or other prerelease build may contain defects, incomplete features, inaccurate content, or behavior that changes before release. Do not rely on a prerelease build for safety-critical, medical, legal, tax, financial, or emergency purposes. Beta access may end without notice and is also subject to Apple's TestFlight terms." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Features, compatibility, question content, and availability may change to correct errors, improve safety, comply with law, or respond to Apple platform changes. Material changes to these Terms will be identified with a new version and presented for acceptance where required." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Ending use, warranties, and responsibility" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "You may end your use by resetting your local profile, stopping use, and deleting the app. V1 state is device-only and is not designed to migrate or restore. Resetting or deleting EDA Unlock does not necessarily delete records independently held by Apple, an email provider, the support mailbox provider, or web-hosting infrastructure." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Subject to the Apple Standard EULA and to the fullest extent permitted by law, EDA Unlock is provided “as is” and “as available.” No guarantee is made of uninterrupted operation, error-free content, a particular educational result, continuous Screen Time protection, exact relocking, or suitability for professional or safety-critical use." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Nothing in these Terms excludes a warranty, remedy, liability, or consumer right that applicable law does not permit to be excluded. Matters these supplemental Terms do not address remain subject to the Apple Standard EULA and applicable law." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Contact" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"Questions about these Terms or EDA Unlock can be sent to ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								href: `mailto:${supportEmail}`,
								children: supportEmail
							}),
