import { i as __toESM, n as __commonJSMin, r as __exportAll, t as require_react } from "./assets/react-pLjWZzrh.js";
...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-B2F54Dao.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-ULbAe8ET.js");
		return {
			get "ErrorBoundary"() {
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-BGQLaE96.js");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { getPrefetchedUrls as a, usePathname as c, createRscRequestUrl as d, app_ssr_entry_default as default, isDangerousScheme as f, handleSsr, getMountedSlotsHeader as i, useRouter as l, VINEXT_MOUNTED_SLOTS_HEADER as m, getCurrentInterceptionContext as n, navigateClientSide as o, AppElementsWire as p, getLayoutSegmentContext as r, prefetchRscResponse as s, require_jsx_runtime as t, createRscRequestHeaders as u };
