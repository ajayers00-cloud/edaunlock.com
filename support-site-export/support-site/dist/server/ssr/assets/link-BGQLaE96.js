import { i as __toESM, t as require_react } from "./react-pLjWZzrh.js";
import { a as withBasePath$1, i as toSameOriginAppPath, n as resolveRelativeHref, o as hasBasePath, r as toBrowserNavigationHref, s as stripBasePath } from "./url-utils-GEhRtWpk.js";
import { a as getPrefetchedUrls, d as createRscRequestUrl, f as isDangerousScheme, i as getMountedSlotsHeader, m as VINEXT_MOUNTED_SLOTS_HEADER, n as getCurrentInterceptionContext, o as navigateClientSide, p as AppElementsWire, s as prefetchRscResponse, t as require_jsx_runtime, u as createRscRequestHeaders } from "../index.js";
...
var Link = (0, import_react.forwardRef)(function Link({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onMouseEnter, onTouchStart, onNavigate, ...rest }, forwardedRef) {
	...
	const handleClick = async (e) => {
		...
		if (typeof window.__VINEXT_RSC_NAVIGATE__ === "function") {
			...
			const Router = (await import("./router-Dnws3KPW.js")).default;
