...
import { i as toSameOriginAppPath, r as toBrowserNavigationHref, s as stripBasePath, t as isHashOnlyBrowserUrlChange } from "./url-utils-GEhRtWpk.js";
import { a as getDomainLocaleUrl, i as addLocalePrefix, n as appendSearchParamsToUrl, r as urlQueryToSearchParams, t as addQueryParam } from "./link-BGQLaE96.js";
...
async function navigateClient(url) {
	...
	try {
		...
		const React = (await import("./react-pLjWZzrh.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1))).default;
		assertStillCurrent();
